...
public class Fireball extends Rectangle{
	...
	public Fireball(int x, int y,LinkedList<Rectangle> tubes2) {
		setBounds(x,y,40, 40);
		this.tubes = tubes2;
	...
	//creating method to get the location of the fireball rectangle, we will use it for the collision system.
